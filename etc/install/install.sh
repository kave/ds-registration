...
find . -type f -name Procfile | xargs sed -i -e "s/registration/$PROJECT_NAME/g"
find . -type f -name .gitignore | xargs sed -i -e "s/registration/$PROJECT_NAME/g"
find . -type f -name "*.json" | xargs sed -i -e "s/registration/$PROJECT_NAME/g"
